...
export default function UsageTips() {
  return (
    <section id={SECTIONS.CONSEILS} className="py-24 bg-gray scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {USAGE_TIPS.map((tip, idx) => (
            <div 
              key={idx}
              className="bg-white border border-border-main p-8 rounded-2xl hover:shadow-md transition-shadow"
            >
